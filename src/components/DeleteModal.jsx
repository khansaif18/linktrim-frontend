...
export default function DeleteModal({ handleCancel, handelDelete }) {
    ...
    return (
        <div className='fixed mt-[-10rem] z-50 w-full h-screen flex items-center justify-center backdrop-blur-[2px]'>
            <div
                className=" bg-gradient-to-br from-gray-900 via-gray-800 to-gray-600  rounded-lg overflow-hidden shadow-xl max-w-sm "
            >
                <div className="p-4">
                    <h2 className="text-3xl font-extrabold mb-2 text-white opacity-70 tracking-wide">DELETE URL?</h2>
                    <p className="text-md mb-4 opacity-60 text-white">
                        Are you sure you wany to delete?
                        url once deleted, cannot be undone..
                    </p>
