...
export default function Login() {
    ...
    return (
        <div className='fixed top-0 w-full h-screen flex items-center justify-center backdrop-blur-md'>
            <div className='flex flex-col gap-2   relative items-center justify-center w-[340px] h-[60vh]  bg-gradient-to-br from-gray-900 via-gray-800 to-gray-600 rounded-xl'>
